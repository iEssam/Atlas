...
- [ ] Dynamic responsiveness protection (§9.7.3) · extended retention tiers (TSDB T1/T2) · expert security metadata · signed plugin framework · remote support bundle · kernel-driver decision gate (subsequent rounds)
